...
(function (window) {
    ...
    const LOGIN_REDIRECT = "/Login/Index";
    ...
    function syncLegacyTokenGlobal() {
    ...
    /** Cartel y contador solo con 5:00 o menos. */
    ...
    function guardPage() {
        if (isLoginPage()) {
            ...
            if (isSessionValid()) {
                window.location.replace(HOME_AFTER_LOGIN);
            } else {
                clearSession();
            }
            return;
